...
1. Download this repository as a [.zip archive](https://github.com/sphinx-ml/artifact-sphinx-plugin/archive/refs/heads/main.zip).
...
6. Direct users to authenticate with Sphinx from the Sphinx connector [configuration page](https://claude.ai/customize/plugins/sphinx-artifact%40sphinx-artifact/connectors).
